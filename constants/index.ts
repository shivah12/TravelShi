export const NAV_LINKS = [
    ...
    { href: "/", key: "how_travelShi_work", label: "How travelShi Work?" },
...
export const FEATURES = [
    ...
    },
    {
        ...
        icon: "/calendar.svg",
        variant: "green",
        description: "Schedule an adventure with friends. On holidays, there are many interesting offers from travelShi. That way, there's no more discussion",
    },
    {
...
export const FOOTER_LINKS = [
    ...
    {
        title: "Our Community",
        links: ["Blog", "Community Forum ", "Reviews"],
    },
];
...
export const FOOTER_CONTACT_INFO = {
    ...
    links: [
        ...
        { label: "Email", value: "travelshi@fmail.com" },
    ],
};
